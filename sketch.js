...
function preload() {
  ...
  robin_running = loadAnimation(
    "Sprites/Robin/robinRun/robinRun1.png",
    "Sprites/Robin/robinRun/robinRun2.png",
    "Sprites/Robin/robinRun/robinRun3.png",
    "Sprites/Robin/robinRun/robinRun4.png",
    "Sprites/Robin/robinRun/robinRun4.png",
    "Sprites/Robin/robinRun/robinRun5.png",
    "Sprites/Robin/robinRun/robinRun6.png",
    "Sprites/Robin/robinRun/robinRun7.png",
    "Sprites/Robin/robinRun/robinRun8.png",
    "Sprites/Robin/robinRun/robinRun9.png",
    "Sprites/Robin/robinRun/robinRun10.png",
    "Sprites/Robin/robinRun/robinRun11.png",
    "Sprites/Robin/robinRun/robinRun12.png"
  );
  ...
  animateSpin = loadAnimation(
    "Sprites/Spinner/Spinner1.png",
    "Sprites/Spinner/Spinner2.png",
    "Sprites/Spinner/Spinner3.png",
    "Sprites/Spinner/Spinner4.png",
    "Sprites/Spinner/Spinner5.png"
  );

  animateObs = loadAnimation(
    "Sprites/Obstacles/Obs1.png",
    "Sprites/Obstacles/Obs2.png",
    "Sprites/Obstacles/Obs3.png",
    "Sprites/Obstacles/Obs4.png",
    "Sprites/Obstacles/Obs5.png"
  );

  animateObstacle = loadAnimation(
    ...
    "Sprites/Obstacles/Obstacle5.png",
    "Sprites/Obstacles/Obstacle6.png",
    "Sprites/Obstacles/Obstacle7.png",
    "Sprites/Obstacles/Obstacle8.png",
    "Sprites/Obstacles/Obstacle9.png",
    "Sprites/Obstacles/Obstacle10.png"
  );

  animateSun = loadAnimation(
    "Sprites/Sun/Sun1.png",
    "Sprites/Sun/Sun2.png",
    "Sprites/Sun/Sun3.png",
    "Sprites/Sun/Sun4.png",
    "Sprites/Sun/Sun5.png"
  );
  ...
  animateGhost1 = loadAnimation(
    "Sprites/Ghosts/Ghost1Frame1.png",
    "Sprites/Ghosts/Ghost1Frame2.png",
    "Sprites/Ghosts/Ghost1Frame3.png",
    "Sprites/Ghosts/Ghost1Frame4.png"
  );

  animateGhost2 = loadImage("Sprites/Ghosts/Ghost2.png");

  animateGhost3 = loadAnimation(
    "Sprites/Ghosts/Ghost3Frame1.png",
    "Sprites/Ghosts/Ghost3Frame2.png",
    "Sprites/Ghosts/Ghost3Frame3.png",
    "Sprites/Ghosts/Ghost3Frame4.png",
    "Sprites/Ghosts/Ghost3Frame5.png"
  );
  ...
  animateCreature1 = loadAnimation(
    "Sprites/Robots/Robot1Frame1.png",
    "Sprites/Robots/Robot1Frame2.png",
    "Sprites/Robots/Robot1Frame3.png",
    "Sprites/Robots/Robot1Frame4.png",
    "Sprites/Robots/Robot1Frame5.png",
    "Sprites/Robots/Robot1Frame6.png"
  );

  animateCreature2 = loadAnimation(
    "Sprites/Monsters/Mons1Frame1.png",
    "Sprites/Monsters/Mons1Frame2.png",
    "Sprites/Monsters/Mons1Frame3.png",
    "Sprites/Monsters/Mons1Frame4.png",
    "Sprites/Monsters/Mons1Frame5.png",
    "Sprites/Monsters/Mons1Frame6.png",
    "Sprites/Monsters/Mons1Frame7.png",
    "Sprites/Monsters/Mons1Frame8.png",
    "Sprites/Monsters/Mons1Frame9.png",
    "Sprites/Monsters/Mons1Frame10.png",
    "Sprites/Monsters/Mons1Frame11.png",
    "Sprites/Monsters/Mons1Frame12.png",
...
function draw() {
  ...
  if (gameState === SERVE) {
    ...
    if (
      GroupHurdles.isTouching(robin) ||
      GroupObstacles.isTouching(robin) ||
      GroupGhostObs.isTouching(robin) ||
      GroupCreatures.isTouching(robin) ||
      ALLGroups.isTouching(robin)
    ) {
      die.play();
      die.setVolume(0.2);
      gameState = END;
  ...
  if (gameState === END) {
    ...
    for (var s = 0; s < 2; s++) {
      star[s] = createSprite(
        ...
        Math.floor(random(200, height - 300)),
        4,
        9
      );
    }
...
function thunderBolt() {
  if (gameState === END) {
    ...
    switch (rand) {
      case 1:
        thunder.addImage(thunderImage1);
        break;

      case 2:
        thunder.addImage(thunderImage2);
        break;

      case 3:
        thunder.addImage(thunderImage3);
        break;

      case 4:
        thunder.addImage(thunderImage4);
        break;
...
function spawnhurdles() {
  if (gameState === END) {
    ...
    switch (rand) {
      case 1:
        hurdle.addImage("Sprites/Hurdles1", hurdleImages1);
        break;

      case 2:
        hurdle.addImage("Sprites/Hurdles2", hurdleImages2);
        break;

      case 3:
        hurdle.addImage("Sprites/Hurdles3", hurdleImages3);
        break;

      case 4:
        hurdle.addImage("Sprites/Hurdles4", hurdleImages4);
        break;
...
function spawnObstacles() {
  if (gameState === END) {
    ...
    switch (rand) {
      case 1:
        obstacle.addAnimation("spinner", animateSpin);
        break;

      case 2:
        obstacle.addAnimation("movingObs", animateObs);
        break;

      case 3:
        obstacle.addAnimation("movingObstacle", animateObstacle);
...
function TransGhost() {
  if (gameState === END) {
    ...
    transGhost = createSprite(
      Math.floor(random(0, width)),
      Math.floor(random(200, height - 210)),
      13,
      18
    );
...
function spawnGhostObs() {
  if (gameState === END) {
    ...
    switch (rand) {
      case 1:
        ghostObs.changeAnimation("flyGhostIdle", ghostIdle1);
        break;

      case 2:
        ghostObs.changeAnimation("skullGhostIdle", ghostIdle2);
        break;
    ...
    switch (rand) {
      case 1:
        ghostObs.addAnimation("flyingGhost", animateGhost1);
        ghostObs.addAnimation("flyGhostIdle", ghostIdle1);
        break;

      case 2:
        ghostObs.addAnimation("skullGhost", animateGhost3);
        ghostObs.addAnimation("skullGhostIdle", ghostIdle2);
        break;

      case 3:
        ghostObs.addImage(animateGhost2);
        break;
...
function spawnCreatures() {
  if (gameState === END) {
    ...
    switch (rand) {
      case 1:
        creatureObs.changeAnimation("robotIdle", creatureImage1);
        break;

      case 2:
        creatureObs.changeAnimation("MonsIdle", creatureImage2);
        break;
    ...
    switch (rand) {
      case 1:
        creatureObs.addAnimation("movingRobot", animateCreature1);
        creatureObs.addAnimation("robotIdle", creatureImage1);
        break;

      case 2:
        creatureObs.addAnimation("runningMons", animateCreature2);
...
function spawnALL() {
  if (gameState != PLAY) {
    ...
    switch (rand) {
      case 9:
        All.changeAnimation("flyGhostIdle", ghostIdle1);
        break;

      case 10:
        All.changeAnimation("skullGhostIdle", ghostIdle2);
        break;

      case 11:
        All.changeAnimation("robotIdle", creatureImage1);
        break;

      case 12:
        All.changeAnimation("MonsIdle", creatureImage2);
        break;
    ...
    switch (randNum) {
      case 1:
        All.addImage("Sprites/Hurdles1", hurdleImages1);
        break;

      case 2:
        All.addImage("Sprites/Hurdles2", hurdleImages2);
        break;

      case 3:
        All.addImage("Sprites/Hurdles3", hurdleImages3);
        break;

      case 4:
        All.addImage("Sprites/Hurdles4", hurdleImages4);
        break;

      case 5:
        All.addAnimation("spinner", animateSpin);
        break;

      case 6:
        All.addAnimation("movingObs", animateObs);
        break;

      case 7:
        All.addAnimation("movingObstacle", animateObstacle);
        break;

      case 8:
        All.addImage(animateGhost2);
        break;

      case 9:
        All.addAnimation("flyingGhost", animateGhost1);
        All.addAnimation("flyGhostIdle", ghostIdle1);
        break;

      case 10:
        All.addAnimation("skullGhost", animateGhost3);
        All.addAnimation("skullGhostIdle", ghostIdle2);
        break;

      case 11:
        All.addAnimation("movingRobot", animateCreature1);
        All.addAnimation("robotIdle", creatureImage1);
        break;

      case 12:
        All.addAnimation("runningMons", animateCreature2);
